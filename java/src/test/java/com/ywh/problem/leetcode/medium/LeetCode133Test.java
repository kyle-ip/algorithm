...
import com.ywh.problem.leetcode.medium.LeetCode133.UndirectedGraphNode;
...
public class LeetCode133Test {
    ...
    @DisplayName("测试图的深拷贝")
    void testCloneGraph() {
        UndirectedGraphNode n1 = new UndirectedGraphNode(1), n2 = new UndirectedGraphNode(2), n4 =
            new UndirectedGraphNode(4), n8 = new UndirectedGraphNode(8);
